...
public class EntityNotFoundOrDeniedException<TIdentifier, TEntity> : EntityNotFoundOrNotExistsExceptionBase
where TEntity : IEntity<TIdentifier>
{
    public EntityNotFoundOrDeniedException(IEnumerable<TIdentifier> notFound, IEnumerable<TIdentifier> accessDenied, UserContext userContext)
    {
        NotFound = notFound;
